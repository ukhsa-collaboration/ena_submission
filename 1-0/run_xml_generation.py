...
parser.add_argument('--dir_of_input_data', '-i', help='please provide the path for the files you like to upload to ENA')
parser.add_argument('-data_file', '-f', help='if you like to add a scientific name or a description to each of your samples in the sample.xml file, please provide the details in a file with each coloumn seperated by a tab, , like this: Scientific_name TAB Description')
